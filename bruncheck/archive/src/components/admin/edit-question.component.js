...
export default function Edituestion(props) {
  var [data, setData] = useState(async () => {
    await fetch(`https://www.bruncheck.com/api/questions/${props.match.params.id}`)
      .then((response) => response.json())
      .then((data) => setData(data));
  });

  // useEffect(() => {
  //   // fetch(`https://www.bruncheck.com/api/questions/${props.match.params.id}`)
  //   //   .then((response) => response.json())
  //   //   .then((data) => setData(data));
      ...
      <div id="admin" className="ms-5 mb-5 mt-5">
        <form
          onSubmit={(e) => {
            console.log(data);
            e.preventDefault();
            fetch(`https://www.bruncheck.com/api/questions/update/${props.match.params.id}`, {
              method: "POST",
              headers: {
        ...
        >
          <h3 className="fs-1 mb-5">Edit Question</h3>
          ...
          <div className="form-group row mb-4">
            ...
            <div className="col-6">
              <input
                ...
                onChange={(e) => {
                  e === "" ? setData({ ...data, breakfast: null }) : setData({ ...data, breakfast: e.target.value });
          ...
          <div className="form-group row mb-4">
            ...
            <div className="col-6">
              <input
                ...
                // required
                className="form-control col-6"
                defaultValue = {data.brunch}
                onChange={(e) => {
                  e === "" ? setData({ ...data, brunch: null }) : setData({ ...data, brunch: e.target.value });
          ...
          <div className="form-group row mb-4">
            ...
            <div className="col-6">
              <input
                ...
                onChange={(e) => {
                  e === "" ? setData({ ...data, lunch: null }) : setData({ ...data, lunch: e.target.value });
          ...
          <div className="form-group row mb-4">
            ...
            <div className="col-6">
              <input
                ...
                onChange={(e) => {
                  e === "" ? setData({ ...data, snack: null }) : setData({ ...data, snack: e.target.value });
          ...
          <div className="form-group row mb-4">
            ...
            <div className="col-6">
              <input
                ...
                onChange={(e) => {
                  e === "" ? setData({ ...data, dinner: null }) : setData({ ...data, dinner: e.target.value });
          ...
          <div className="form-group row mb-4">
            ...
            <div className="col-6">
              <input
                ...
                // required
                className="form-control col-6"
                defaultValue={data.dessert}
                onChange={(e) => {
                  e === "" ? setData({ ...data, dessert: null }) : setData({ ...data, dessert: e.target.value });
